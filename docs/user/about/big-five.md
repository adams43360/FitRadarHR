...
Le questionnaire est disponible en français, anglais, allemand et espagnol. La rigueur
scientifique de chaque traduction n'est cependant pas identique :

| Langue | Couverture officielle IPIP | Source |
|---|---|---|
| 🇫🇷 Français | Adaptation professionnelle des 100 items | — |
| 🇬🇧 Anglais | 100/100 — version originale | Goldberg (1992) |
| 🇩🇪 Allemand | 100/100 — traduction officielle validée par rétro-traduction | Streib & Wiedmaier (2001), Universität Bielefeld |
| 🇪🇸 Espagnol | 50/100 officiels — les 50 items d'extension sont traduits par nos soins | de Oliveira, Cherubini & Oliver (2013), ACM TOCHI |

!!! warning "Limite de validation sur la version espagnole longue (100 items)"
    Pour la version courte (50 items), les 50 items espagnols proviennent tous d'une
    traduction officielle publiée par IPIP. Pour la version longue (100 items), la
    moitié des items espagnols (ceux qui étendent le questionnaire de 50 à 100 items)
    n'ont pas de traduction officielle publiée : ils ont été traduits par l'équipe
    FitRadarHR, dans un registre cohérent avec le reste du questionnaire, mais sans
    validation psychométrique indépendante (pas d'étude de fiabilité ou d'analyse
    factorielle dédiée à cette traduction). Si vous utilisez la version 100 items en
    espagnol dans un contexte à enjeu élevé, tenez compte de cette limite. Détail
    complet de la méthodologie de traduction dans `docs/product/translations-ipip.md`
    (dépôt du code).
